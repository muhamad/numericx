...
** File:  int_t.hpp
**
** Purpose: numeric_limits for int_t
**
===========================================================*/

#ifndef MATHX_STL_LIMITS_INT_T_HPP
#define MATHX_STL_LIMITS_INT_T_HPP

namespace std
{

template<mathx::cu_t bits_count, typename ut_t, typename st_t, typename udt_t, typename sdt_t,
...
class numeric_limits < mathx::int_t<bits_count, ut_t, st_t, udt_t, sdt_t, range_t, bitwise_t, logic_t, arithmetic_t, meta_t> >
{
	typedef mathx::int_t<bits_count, ut_t, st_t, udt_t, sdt_t, range_t, bitwise_t, logic_t, arithmetic_t, meta_t> t;
...
#endif // MATHX_STL_LIMITS_INT_T_HPP
